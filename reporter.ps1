...
."C:\tools\unity\2022.3.37f1\Editor\Unity.exe" -projectPath "C:\arquivo\10-19 Praticas\11 Projetos\11.20 Repos de empregos\cegep--em\unity-scene-reporter" -executeMethod "SceneReporter.CreateReport" -logFile log.txt -quit